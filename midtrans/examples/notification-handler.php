...
Config::$serverKey = 'SB-Mid-server-PtCtkrVF0ktjDDUA4ZZ8rW2C';
...
if ($transaction == 'settlement') {
   ...
   include "koneksi.php";
   mysqli_query($koneksi,"update klien set transaction_status='3' , transaction_id='$transaction_id' where order_id='$order_id'");
       ...
       include "koneksi.php";
   mysqli_query($koneksi,"update klien set transaction_status='2' where order_id='$order_id'");
 
} else if ($transaction == 'deny') {
      include "koneksi.php";
   mysqli_query($koneksi,"update klien set transaction_status='1' where order_id='$order_id'");
